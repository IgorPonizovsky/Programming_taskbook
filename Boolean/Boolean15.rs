// Пн 11 дек 2023 15:11:53 MSK
// Даны три целых числа: A, B, C. Проверить истинность высказывания: 
// "Ровно два из чисел A, B, C положительное". 
...
fn main() { 
    ...
    if t_f == true { 
        println!("Ровно два из чисел A, B, C положительные"); 
    } else { 
        println!("Нет ровно друх из чисел A, B, C положительных"); 
    }; 
} 
