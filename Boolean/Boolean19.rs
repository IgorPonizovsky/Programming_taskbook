// Пн 11 дек 2023 17:06:04 MSK
// Проверить истинность высказывания: 
// "Среди трёх данных целых чисел есть хотя бы одна пара взаимно противоположных".
...
fn main() { 
    ...
    if t_f == true { 
        println!("Среди трёх данных целых чисел есть хотя бы одна пара взаимно противоположных"); 
    } else { 
        println!("Среди трёх данных целых чисел нет ни одной пары взаимно противоположных"); 
    }; 
} 
