...
fn main() { 
    ...
    if (x1 - x2).abs() == (y1 - y2).abs() { 
        println!("Слон за один ход может перейти с одного поля на другое"); 
    } else { 
        println!("Слон за один ход не может перейти с одного поля на другое"); 
    }; 
} 
