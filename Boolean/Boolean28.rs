...
fn main() { 
    ...
    if ((x > 0) && (y > 0)) | ((x < 0) && (y < 0)) { 
        println!("Точка лежит в первой или третьей координатной четверти"); 
    } else { 
        println!("Точка не лежит в первой или третьей координатной четверти"); 
    }; 
} 
